...
var vm = new Vue({
	...
	methods: {
		...
		saveOrUpdate: function (event) {
			var url = vm.menu.menuId == null ? "qxgl/menu/save" : "qxgl/menu/update";
			$.ajax({
				type: "POST",
			    url: baseURL + url,
		...
		getInfo: function(menuId){
			$.get(baseURL + "qxgl/menu/info/"+menuId, function(r){
                vm.menu = r.menu;
            });
		},
