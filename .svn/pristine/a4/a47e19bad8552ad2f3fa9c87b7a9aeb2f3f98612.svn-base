...
public class SummaryMonthEntity implements Serializable {
	 ...
	 * 当月总电量 即截止本月电表读数
	 */
	private Double month_total_power;
	/**
	 * 当月电费
	 */
	 ...
	 * 最大需量
	 */
	private Double month_max_power_demand;
	/**
	 * 最大需量时间
	 */
	 ...
	 * 设置：当月使用电量
	 */
	public void setmonth_power(Double month_power) {
		this.month_power = month_power;
	}
	/**
	 * 获取：当月使用电量
	 */
	public Double getmonth_power() {
		return month_power;
	}
	/**
	 * 设置：当月总电量 即截止本月电表读数
	 */
	public void setmonth_total_power(Double month_total_power) {
		this.month_total_power = month_total_power;
	}
	/**
	 * 获取：当月总电量 即截止本月电表读数
	 */
	public Double getmonth_total_power() {
	 ...
	 * 设置：最大需量
	 */
	public void setmonth_max_power_demand(Double month_max_power_demand) {
		this.month_max_power_demand = month_max_power_demand;
	}
	/**
	 * 获取：最大需量
	 */
	public Double getmonth_max_power_demand() {
	 ...
	 * 设置：
	 */
	public void setstationd_id(Long stationd_id) {
		this.stationd_id = stationd_id;
	}
	/**
	 * 获取：
	 */
	public Long getstationd_id() {
		return stationd_id;
	}
	/**
	 * 设置：站点名称
