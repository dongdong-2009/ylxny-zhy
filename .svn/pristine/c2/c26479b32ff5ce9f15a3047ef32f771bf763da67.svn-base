...
public class DmDictController {
    ...
    public R listbyPIdLxId(@RequestParam(value = "pid", required = true,defaultValue = "0") Long parentId,@RequestParam(value = "lxid",  required = true ) Long lxId,@RequestParam(value = "showSl", defaultValue = "20")Integer showSl ){
